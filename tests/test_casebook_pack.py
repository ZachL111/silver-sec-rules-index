"""Regression checks for the silver-sec-rules-index casebook."""
...
from casebook.harness import assert_expected, silver_sec_rules_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_sec_rules_index_summary(), assert_expected())
